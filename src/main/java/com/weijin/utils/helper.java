...
import com.weijin.model.Rank;
import com.weijin.model.Suit;
...
public class helper {
    static final String FIXED_POKER_IMG_URL = "/static/pictures/poker_imgs/";
    static final String FIXED_SUIT_IMG_URL = "/static/pictures/suit_icons/";
    static final String POSTFIX = ".gif";

    public static Image CardToImage(Card card) {
        String path;
        if (card == null) {
            path =FIXED_POKER_IMG_URL + "back" + POSTFIX;
        } else {
            path =FIXED_POKER_IMG_URL + card.getId() + POSTFIX;
        }
    ...
    public static Image SuitToImage(Suit suit) {
        ...
        if (suit == null) {
            ...
            path = FIXED_SUIT_IMG_URL + suit.toString().toLowerCase() + POSTFIX;
        }
